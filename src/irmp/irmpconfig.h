...
#define IRMP_SUPPORT_KASEIKYO_PROTOCOL          0       // support Kaseikyo     >= 10000                  ~50 bytes
#define IRMP_SUPPORT_DENON_PROTOCOL             0       // support DENON        >= 10000                 ~250 bytes
...
#define IRMP_BIT                                2       // use PD2 as IR input on AVR
